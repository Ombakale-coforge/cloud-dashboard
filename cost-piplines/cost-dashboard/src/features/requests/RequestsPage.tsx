        ...
        <header className="sticky top-0 z-50 flex items-center justify-between border-b bg-background/80 px-6 py-3.5 backdrop-blur">
          ...
          <div className="flex items-center gap-3">
            ...
            {isAdmin && (
              <button
                onClick={() => navigate("/")}
                className="flex items-center gap-1.5 rounded-xl border border-border bg-card px-3.5 py-1.5 text-xs font-semibold text-foreground hover:bg-muted/50 transition-colors cursor-pointer"
              >
                <ArrowLeft size={14} />
            ...
            <div className="space-y-4">
              ...
              {myRequests.length === 0 ? (
                <div className="rounded-2xl border border-border bg-card p-12 text-center text-muted-foreground">
                  ...
                  <button
                    onClick={() => setActiveView("form")}
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-primary text-primary-foreground text-xs font-semibold shadow-sm hover:opacity-90 cursor-pointer"
                  >
                    <PlusCircle size={14} />
